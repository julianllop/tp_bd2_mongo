...
export const deleteMedico = (id) => api.delete(`/medicos/${id}`).then((r) => r.data);
...
export const createConsulta = (data) => api.post("/consultas", data).then((r) => r.data);
export const updateConsulta = (id, data) => api.put(`/consultas/${id}`, data).then((r) => r.data);
export const deleteConsulta = (id) => api.delete(`/consultas/${id}`).then((r) => r.data);
